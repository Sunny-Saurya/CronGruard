...
export const GlassCard = ({
  ...
  const baseClasses = "relative modern-card"

  const hoverClasses = hover ? "modern-card-hover" : ""
...
export const ModernButton = ({
  ...
  const variantClasses = {
    primary: "modern-btn modern-btn-primary",
    secondary: "modern-btn bg-background text-foreground border-foreground",
    outline: "modern-btn bg-transparent text-foreground/70 border-foreground/30 hover:border-foreground hover:text-foreground",
  }
