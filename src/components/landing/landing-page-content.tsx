...
export function LandingPageContent() {
  ...
  return (
    <GSAPProvider>
      ...
      >
        <MaxWidthWrapper className="relative">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="hero-title mb-4 sm:mb-6 inline-flex items-center gap-1.5 border border-primary/20 bg-primary/5 text-primary px-3 py-1 font-heading text-base sm:text-lg uppercase tracking-wider">
            ...
            <p className="hero-subtitle mt-4 sm:mt-6 max-w-2xl text-sm sm:text-base lg:text-lg text-foreground/80 px-1 font-medium">
              CronGuard is the easiest way to monitor your SaaS. Get instant notifications for{" "}
            ...
            <div className="hero-cta mt-8 flex flex-col sm:flex-row gap-3 w-full sm:w-auto px-2 sm:px-0">
              <MagneticElement strength={0.15}>
                <ModernButton href="/sign-up" variant="primary" size="md" className="w-full sm:w-auto">
                  Start for Free <ArrowRight className="size-4" />
                </ModernButton>
              </MagneticElement>
              <MagneticElement strength={0.15}>
                <ModernButton href="#features" variant="outline" size="md" className="w-full sm:w-auto">
                  See Features
                </ModernButton>
              </MagneticElement>
            </div>
      ...
      <div className="modern-divider max-w-6xl mx-auto my-6" />
            ...
            {stats.map((stat, index) => (
              ...
              >
                <GlassCard variant="neo" className="p-4 sm:p-6 bg-card border-foreground/10">
                  <div className="text-3xl sm:text-4xl lg:text-5xl font-heading text-primary">
                    {stat.value}
                  </div>
      ...
      >
        <MaxWidthWrapper>
          <div className="text-center mb-12">
            <span className="inline-block px-3 py-1 border border-primary/20 bg-primary/5 text-primary text-base font-heading uppercase tracking-wider mb-3">
              Overview
            </span>
              ...
              <div>
                <GlassCard variant="neo" className="h-full overflow-hidden bg-card border-foreground/10">
                  <div className="p-5 sm:p-6">
                    ...
                    <p className="mt-2 text-xs sm:text-sm text-foreground/70 font-medium">
                      Connect CronGuard with your workflows in minutes with our simple API client.
                    </p>
                  </div>
                  <div className="relative mx-4 mb-4 border border-foreground/10 bg-card overflow-hidden shadow-[2px_2px_0_0_rgba(0,0,0,0.05)]">
                    <div className="flex items-center gap-1.5 px-3 py-2 bg-background border-b border-foreground/10">
                      ...
                      <span className="text-[10px] text-foreground/60 ml-1 font-mono">cronguard.js</span>
                    </div>
          ...
          <div>
            <GlassCard variant="neo" className="p-6 sm:p-10 lg:p-14 text-center bg-card border-foreground/10">
              ...
              <p className="text-xs sm:text-sm lg:text-base text-foreground/75 mb-6 max-w-xl mx-auto font-medium">
                Join hundreds of SaaS founders who are already monitoring their business with CronGuard.
              </p>
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-8">
            <div className="lg:w-1/3">
              <Link href="/" className="inline-block">
                <span className="text-2xl font-heading text-foreground uppercase tracking-wider">CronGuard</span>
              </Link>
              <p className="mt-2 text-xs sm:text-sm text-foreground/70 font-medium">
                Real-Time Application Monitoring. Instant Discord Alerts.
              </p>
            </div>
