...
const Logos = () => {
  return (
    <Link href="/" className="flex z-40 items-center gap-2">
      ...
      <span className="hidden sm:block text-foreground font-heading text-2xl tracking-wider uppercase">
        CronGuard
      </span>
    </Link>
  )
...
const Layout = ({ children }: PropsWithChildren) => {
  ...
  return (
    <div className="relative h-screen flex flex-col md:flex-row bg-background overflow-hidden">
      ...
      <div className="absolute inset-0 modern-bg-pattern opacity-30 pointer-events-none" />
