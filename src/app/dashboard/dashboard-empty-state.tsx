  ...
  return (
    <Card className="flex flex-col items-center justify-center flex-1 text-center p-8 bg-card border-foreground/10 rounded-none shadow-[3px_3px_0_0_rgba(0,0,0,0.05)]">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
        <button
          className="modern-btn px-6 py-2.5 text-xs w-full sm:w-auto flex items-center justify-center gap-2 cursor-pointer"
        ...
        <CreateEventCategoryModal containerClassName="w-full sm:w-auto">
          <button className="modern-btn modern-btn-primary px-6 py-2.5 text-xs w-full sm:w-auto flex items-center justify-center gap-2 cursor-pointer">
